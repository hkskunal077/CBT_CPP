...
void inst()                              //data handing
{
ques Q;
fstream a("qus.dat",ios::app|ios::in|ios::binary);
cout<<"inst question?(y/n)\t";
char ch;
cin>>ch;
...
cans[0]=Q.can;
outtextxy(0,290,"crrct ans");outtextxy(100,290,cans);
a.close();
}
...
outtextxy(10,50,"fshfs siuhfsifhs sihfsifhsifs fhsfhseuihfu");
outtextxy(10,80,"duddgiui iuifhsih igiuhhdig dhgdui digdhgi");
outtextxy(10,110,"doioog d8ghdgh igud f8g  ghgdgdh uihgiudug o86g");
...
switch(I)
{
	...
	fstream a("qus.dat",ios::in|ios::binary);
		...
		{
		setcolor(LIGHTGREEN);
		outtextxy(5+150*i,5,"crrct");
		outtextxy(5+150*i,15,"ans");

		setcolor(YELLOW);
		outtextxy(55+150*i,5,"your");
		outtextxy(55+150*i,15,"ans");
	...
	outtextxy(470,100,"Your marks is -ve");
